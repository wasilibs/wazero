...
export functions using [HostModuleBuilder](https://pkg.go.dev/github.com/wasilibs/wazerox#HostModuleBuilder) and how a
...
[wasi package](https://pkg.go.dev/github.com/wasilibs/wazerox/wasi).
