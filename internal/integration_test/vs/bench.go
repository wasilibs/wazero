...
//
//	-ldflags '-X github.com/wasilibs/wazerox/internal/integration_test/vs.ensureCompilerFastest=true'
...
// This is disabled by default, and can be run with -ldflags '-X github.com/wasilibs/wazerox/vs.ensureCompilerFastest=true'.
